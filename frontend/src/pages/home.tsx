...
export default function Home() {
  ...
  return (
    <div className="home-container">
      ...
      {/* Seção Hero Banner */}
      <section className="home-hero styled-hero">
      ...
      <section id="sobre-nos" className="home-section alt-bg">
        <div className="section-content styled-section reversed">
          <img 
            ...
            src="/src/assets/images/sobre-nos.jpg" 
            alt="Sobre Nós" 
          />
      ...
      <section id="doacao-monetaria" className="home-section">
        <div className="section-content styled-section">
          <img 
            className="section-image" 
            src="/src/assets/images/doacao-monetaria.jpg" 
      ...
      <section id="doacao-roupas" className="home-section alt-bg">
        <div className="section-content styled-section reversed">
          <img 
            className="section-image" 
            src="/src/assets/images/doacao-roupas.jpg" 
      ...
      <section id="doacao-alimentos" className="home-section">
        <div className="section-content styled-section">
          <img 
            className="section-image" 
            src="/src/assets/images/doacao-alimentos.jpg" 
      ...
      <section id="apoio-imigrantes" className="home-section alt-bg">
        <div className="section-content styled-section reversed">
          <img 
            className="section-image" 
            src="/src/assets/images/apoio-imigrantes.jpg" 
          ...
          <div className="text-block">
            ...
            <button 
              className="section-cta"
              onClick={() => navigate('/apoio-imigrantes')}
            >
              Ver Suporte
            </button>
          </div>
      ...
      <section id="voluntariado" className="home-section">
        <div className="section-content styled-section">
          <img 
            className="section-image" 
            src="/src/assets/images/voluntariado.jpg" 
            alt="Voluntariado" 
          />
          <div className="text-block">
