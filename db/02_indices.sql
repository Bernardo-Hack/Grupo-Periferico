...
CREATE INDEX idx_doacao_dinheiro_metodo ON DoacaoDinheiro(metodo_pagamento); 
...
CREATE INDEX idx_distribuicao_data ON Distribuicao(data_distribuicao); -- Filtro por data
CREATE INDEX idx_distribuicao_composto ON Distribuicao(tipo_doacao, data_distribuicao); -- Combinação
